...
export default function Auth() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <Card className="w-[350px] z-10 shadow-2xl animate-in fade-in zoom-in duration-500 bg-white/70 backdrop-blur-md border border-gray-200">
                <CardHeader>
                    <CardTitle className="text-2xl text-center text-gray-900">Welcome Back</CardTitle>
                    <CardDescription className="text-center text-gray-500">Enter your credentials to access the dashboard</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full bg-[#1a73e8] hover:bg-[#1557b0] text-white shadow-md">Sign In</Button>
                    </form>
                </CardContent>
